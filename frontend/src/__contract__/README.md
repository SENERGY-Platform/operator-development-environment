...
files of M4, and the `chart_*` plus `charts.json` files of M5 were emitted by the
API test harness for the same reason, and are regenerated by a test rather than by
curl:
