...
| `experiment_default_entrypoint` | `python training.py` | The scaffold of §5.11 item 3 puts the Ray task in `training.py`, so the default points at what a scaffolded repository actually has |
